...
@section('content')
    <div class="container-fluid">
                ...
                <div class="card border-left-primary shadow h-100">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="mb-3">
                                    <label class="small font-weight-bold text-uppercase text-muted mb-1">Nama
                                        Pemesan</label>
                                    <div class="h6 mb-0 font-weight-bold text-gray-800">{{ $order->name }}</div>
                                </div>
                                <div class="mb-3">
                                    <label class="small font-weight-bold text-uppercase text-muted mb-1">Nomor
                                        WhatsApp</label>
                ...
                <div class="card border-left-success shadow h-100">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="mb-3">
                                    <label class="small font-weight-bold text-uppercase text-muted mb-1">Jenis
                                        Produk</label>
                                    <div class="h6 mb-0 font-weight-bold text-gray-800">{{ $order->product->name }}</div>
                                </div>
                                <div class="mb-3">
                                    <label class="small font-weight-bold text-uppercase text-muted mb-1">Harga
                                        Satuan</label>
                                    <div class="h6 mb-0 font-weight-bold text-gray-800">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="text-center mb-3">
                            <img src="{{ asset('storage/images/orders/' . $order->path_file) }}" alt="Gambar Desain"
                                class="img-fluid rounded shadow" style="max-height: 300px; border: 1px solid #eee;">
                        </div>
        ...
        <!-- Add this section right before the Status Update Button -->
        <!-- Payment Proof Section - Image Only -->
        @if ($order->payment_proof)
            <div class="card border-left-success shadow mb-4">
                <div class="card-header py-3 bg-white">
                    <h6 class="m-0 font-weight-bold text-success">
                        <i class="fas fa-money-bill-wave mr-1"></i> Bukti Pembayaran
                    </h6>
                </div>
        ...
        <div class="text-center mb-5">
            <button type="button" class="btn btn-primary btn-icon-split btn-lg px-3" data-toggle="modal"
