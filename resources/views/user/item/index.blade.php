    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
            <div class="card h-100">
                <!-- Product Image -->
                <img src="{{ asset($item->image != 'noimage.jpg' ? 'storage/images/products/' . $item->image : 'assets/img/printing-default.jpg') }}"
                     class="card-img-top"
                     alt="{{ $item->name }}">
                ...
                <div class="card-footer bg-white">
                    <div class="row">
                        ...
                        <div class="col-5 pl-1">
                            <a href="{{ route('user.items.show', $item->id) }}" class="btn btn-outline-secondary btn-sm btn-block">
